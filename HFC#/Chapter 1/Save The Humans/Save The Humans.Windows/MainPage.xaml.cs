...
using Windows.UI.Xaml.Media.Animation;  // to use the animation from the .NET framework
...
namespace Save_The_Humans
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        {
            /* this code runs every time the timer ticks */
            progressBar.Value += 1;
        ...
        {
            /* This method ends the game by stopping the timers, making the Start button visisble again and
             * adding the GAME OVER text to the playArea */
        ...
        private void AddEnemy()
        {
            ...
            playArea.Children.Add(enemy); // add the new enemy control to a Children collection
        ...
        private void AnimateEnemy(ContentControl enemy, double from, double to, string propertyAnimate)
        {
            ...
            {
                // The code below makes the created enemy move across the playArea
                From = from,
                To = to,
                Duration = new Duration(TimeSpan.FromSeconds(random.Next(4, 6))) // change the values of 4 and 6 to alter the speed
            };
