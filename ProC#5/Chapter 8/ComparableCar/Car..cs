...
namespace CustomEnumerator
{
    public class Car : IComparable
    {
        ...
        public static IComparer SortByPetName { get { return (IComparer)new ComparableCar.Program.PetNameComparer(); } }
        ...
        int IComparable.CompareTo(object obj)
        {
            ...
            if (temp != null)
            {
                ...
                throw new ArgumentException("Parameter is not a valid Car object!");
        }
